...
$('.tabbed_area[data-type="movie"] li.test_movie').text($divs_movie.length);
...
$('.tabbed_area[data-type="movie"] #tab_movie_alpha').on('click', function () {
	...
	$('.tabbed_area[data-type="movie"] li.test_movie').text($divs_movie.length + ' ' + alphabeticallyOrderedDivs_movie.length + ' '+ $('.tabbed_area[data-type="movie"] .tab').length);
});
